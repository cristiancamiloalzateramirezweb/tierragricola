<%-- 
    Document   : Ganaderia
    Created on : 29/06/2021, 12:04:00 AM
...
<html lang="en">
    <head>
        ...
        <title>Ganadería en Colombia, venta de Ganadería en Colombia | Tierragricola</title>
    ...
    <body>
        ...
        <div class="wrap">
            <h1>Ganadería en Tierragricola de Colombia 🐄🐎🐑🐐🐓🐖</h1>
            <div class="store-wrapper">
                <h2>Filtra por:</h2>
                <div class="category_list">
                    <a href="#" class="category_item" category="all">Todas</a>
                    <a href="#" class="category_item" category="Bovina">Bovina</a>
                    <a href="#" class="category_item" category="Equina">Equina</a>
                    <a href="#" class="category_item" category="Ovina">Ovina</a>
                    <a href="#" class="category_item" category="Caprina">Caprina</a>
                    <a href="#" class="category_item" category="Avicola">Avicola</a>
                    <a href="#" class="category_item" category="Porcina">Porcina</a>
                </div>
