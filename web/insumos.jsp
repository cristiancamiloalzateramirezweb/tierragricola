<%-- 
    Document   : Insumos
    Created on : 5/08/2021, 05:17:47 PM
...
<html lang="en">
    <head>
        ...
        <title>Insumos en Colombia, venta de Insumos en Colombia | Tierragricola</title>
    ...
    <body>
        ...
        <div class="wrap">
            <h1>Insumos en Tierragricola de Colombia 🥾🪓🔨⛏</h1>
            <div class="store-wrapper">
                <h2>Filtra por:</h2>
                <div class="category_list">
                    <a href="#" class="category_item" category="all">Todas</a>
                    <a href="#" class="category_item" category="Cuidos">Cuidos</a>
                    <a href="#" class="category_item" category="Accesorios">Accesorios</a>
                    <a href="#" class="category_item" category="Abonos">Abonos</a>
                    <a href="#" class="category_item" category="Fertilizantes">Fertilizantes</a>
                    <a href="#" class="category_item" category="Semillas">Semillas</a>
                    <a href="#" class="category_item" category="Máquinas">Máquinas</a>
