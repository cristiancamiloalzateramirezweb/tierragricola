<%-- 
    Document   : Mascotas
    Created on : 5/08/2021, 05:16:52 PM
...
<html lang="en">
    <head>
        ...
        <title>Mascotas en Colombia, venta de Mascotas en Colombia | Tierragricola</title>
    ...
    <body>
        ...
        <div class="wrap">
            <h1>Mascotas en Tierragricola de Colombia 🐕🐈🐇🦜🐟</h1>
            <div class="store-wrapper">
                ...
                <div class="category_list">
                    ...
                    <a href="#" class="category_item" category="Conejos">Conejos</a>
                    <a href="#" class="category_item" category="Roedores">Roedores</a>
                    <a href="#" class="category_item" category="Pajaros">Pajaros</a>
                    <a href="#" class="category_item" category="Peces">Peces</a>
                </div>
