 ...
 * @author camil
 */
public class tierragricola extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<DTODepartamento> listarDepartamentos = daoDepartamento.listarDepartamentoClientesDestacados();
            List<DTOMunicipio> listarMunicipios = daoMunicipio.listarMunicipioClientesDestacados();
            List<DTOClienteProducto> listarClienteProducto = daoClienteProducto.listarClientesProductosDestacados();
            List<DTOProducto> listarProductos = daoProducto.listarProductosDestacados();
            ...
            request.getRequestDispatcher("tierragricola.jsp").forward(request, response);
        }
    }
