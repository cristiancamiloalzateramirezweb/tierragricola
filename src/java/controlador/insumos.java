...
public class insumos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<DTODepartamento> listarDepartamentos = daoDepartamento.listarDepartamentoClientesInsumos();
            List<DTOMunicipio> listarMunicipios = daoMunicipio.listarMunicipioClientesInsumos();
            List<DTOClienteProducto> listarClienteProducto = daoClienteProducto.listarClientesProductosInsumos();
            List<DTOProducto> listarProductos = daoProducto.listarProductosInsumos();
            List<DTOCategoria> listarCategorias = daoCategoria.listarCategoriaProductosInsumos();
