 ...
 * @author camil
 */
public class aceptarNegocio extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean editarCantidadProducto = daoProducto.editarCantidadProducto(numero_folio);
            ...
            String cuerpo_comprador = "Desde Tierragricola tenemos noticias para ti... la solicitud en el negocio del "
                    + "producto " + producto + " ha sido aceptada por parte de " + vendedor + " el vendedor del producto. Cordial Saludo, Tierragricola.";
            ...
            String cuerpo_vendedor = "¡Hola!, Desde Tierragricola hemos enviado la respuesta de la solicitud a " + comprador + " "
                    + "solicitante del producto " + producto + " te dejamos acontinuación su correo eléctronico " + destinatario_comprador + " para "
                    + "que termine la negociación y entrega del producto. Feliz termino de la negoción. Cordial Saludo, Tierragricola.";

            if (editarVenta == true && editarCantidadProducto) {
