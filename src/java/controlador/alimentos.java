...
public class alimentos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<DTODepartamento> listarDepartamentos = daoDepartamento.listarDepartamentoClientesAlimentos();
            List<DTOMunicipio> listarMunicipios = daoMunicipio.listarMunicipioClientesAlimentos();
            List<DTOClienteProducto> listarClienteProducto = daoClienteProducto.listarClientesProductosAlimentos();
            List<DTOProducto> listarProductos = daoProducto.listarProductosAlimentos();
            List<DTOCategoria> listarCategorias = daoCategoria.listarCategoriaProductosAlimentos();
