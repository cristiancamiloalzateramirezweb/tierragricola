    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (usuario != null) {
                ...
                DTODepartamento dtoDepartamento = daoDepartamento.obtenerDepartamentoUsuario(usuario.getDocumento_identidad());
                DTOMunicipio dtoMunicipio = daoMunicipio.obtenerMunicipioUsuario(usuario.getDocumento_identidad());
                List<DTODepartamento> listaDepartamentos = daoDepartamento.listarDepartamentos();
                misession.setAttribute("usuario", dtoUsuario);
                request.setAttribute("departamento", dtoDepartamento);
                request.setAttribute("municipio", dtoMunicipio);
