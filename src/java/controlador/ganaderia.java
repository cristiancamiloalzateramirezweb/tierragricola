 ...
 * @author camil
 */
public class ganaderia extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<DTODepartamento> listarDepartamentos = daoDepartamento.listarDepartamentoClientesGanaderia();
            List<DTOMunicipio> listarMunicipios = daoMunicipio.listarMunicipioClientesGanaderia();
            List<DTOClienteProducto> listarClienteProducto = daoClienteProducto.listarClientesProductosGanaderia();
            List<DTOProducto> listarProductos = daoProducto.listarProductosGanaderia();
            List<DTOCategoria> listarCategorias = daoCategoria.listarCategoriaProductosGanaderia();
            ...
            request.getRequestDispatcher("ganaderia.jsp").forward(request, response);
        }
    }
